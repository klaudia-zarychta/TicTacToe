...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if ((grid[i][0] == 'x' && grid[i][1] == 'x' && grid[i][2] == 'x') || (grid[0][j] == 'x' && grid[1][j] == 'x' && grid[2][j] == 'x') || (grid[0][0] == 'x' && grid[1][1] == 'x' && grid[2][2] == 'x') || (grid[0][2] == 'x' && grid[1][1] == 'x' && grid[2][0] == 'x')) {
                    result = "X wins";
                    break;
                } else if ((grid[i][0] == 'o' && grid[i][1] == 'o' && grid[i][2] == 'o') || (grid[0][j] == 'o' && grid[1][j] == 'o' && grid[2][j] == 'o') || (grid[0][0] == 'o' && grid[1][1] == 'o' && grid[2][2] == 'o') || (grid[0][2] == 'o' && grid[1][1] == 'o' && grid[2][0] == 'o')) {
                    result = "O wins";
                    break;

                } else if (result != "X wins" && result != "O wins" && grid[0][0] != '-' && grid[1][0] != '-' && grid[2][0] != '-' && grid[0][1] != '-' && grid[1][1] != '-' && grid[2][1] != '-' && grid[0][2] != '-' && grid[1][2] != '-' && grid[2][2] != '-') {
                    result = "Tie";
                    break;
                } else {
                    return result;
